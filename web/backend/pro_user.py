...
SERVICE_CONF = {
    ...
    'clean_dirs': {'name': '目录清理', 'time': '手动', 'state': 'OFF', 'svg': '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-folder-minus" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n                       <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>\n                       <path d="M5 4h4l3 3h7a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-11a2 2 0 0 1 2 -2"></path>\n                       <line x1="9" y1="13" x2="15" y2="13"></line>\n                    </svg>', 'color': 'lime', 'level': 1},
...
1. 如果曾经修改: 请去 https://raw.githubusercontent.com/carl800-1/nas-tools-sites/master/user.sites.bin 下载后还原
2. 如果从未修改: 请去 https://github.com/carl800-1/nas-tools/issues 创建issue，并附上报错信息
----------------------------------------------------------------------------------------------------------
            """
            log.info(f"【User】\n{recovery_msg}")
            return {}, [], {}
