...
> 当前版本：**v6.0.2** ｜ 镜像：`ghcr.io/carl800-1/nas-tools` ｜ 端口：`3000` ｜ 协议：AGPL-3.0
...
```bash
docker pull ghcr.io/carl800-1/nas-tools:6.0.2   # 也可继续用 latest
docker compose up -d
```
...
_Last updated: 2026-09-23 ｜ 当前版本 v6.0.2_
