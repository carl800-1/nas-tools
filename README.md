...
> 当前版本：**v4.1.1** ｜ 镜像：`ghcr.io/carl800-1/nas-tools` ｜ 端口：`3000` ｜ 协议：AGPL-3.0
...
```bash
docker pull ghcr.io/carl800-1/nas-tools:4.1.1   # 也可继续用 latest
docker compose up -d
```
...
_Last updated: 2026-09-17 ｜ 当前版本 v4.1.1_
